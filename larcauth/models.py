...
class evaluation(models.Model):
    ...
    all_grades = models.CharField(max_length=250,null=True)
    all_grades_a = models.CharField(max_length=250, null=True)
    all_grades_b = models.CharField(max_length=250, null=True)
    all_grades_c = models.CharField(max_length=250, null=True)
    all_grades_d = models.CharField(max_length=250, null=True)
    all_grades_e = models.CharField(max_length=250, null=True)
    all_grades_f = models.CharField(max_length=250, null=True)
